...
class Historicodia_tutorWidget extends StatefulWidget {

  final DateTime selectedDate;

  const Historicodia_tutorWidget({super.key, required this.selectedDate});

  @override
  State<Historicodia_tutorWidget> createState() => _Historicodia_tutorWidgetState();
}

class _Historicodia_tutorWidgetState extends State<Historicodia_tutorWidget> {
